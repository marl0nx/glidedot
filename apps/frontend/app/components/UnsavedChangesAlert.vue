  ...
  <Teleport to="body">
    ...
    >
      <div v-if="hasUnsavedChanges" class="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] w-full max-w-md px-4 pointer-events-none">
        <div class="bg-neutral-900/95 backdrop-blur-lg border border-neutral-800 rounded-xl shadow-[0_0_40px_rgba(0,0,0,0.5)] p-3 flex items-center justify-between pointer-events-auto ring-1 ring-white/10">
